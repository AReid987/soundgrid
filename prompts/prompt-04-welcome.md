...
page: welcome
---
Authentication & Onboarding: Welcome success page
...
**Page Structure:**
1. Center-aligned success icon or graphic (utilizing Teal Mint for success indication).
2. Large display heading: "You're all set".
3. Short celebratory or instructional body text.
4. Large Primary CTA button: "Create first contract".
