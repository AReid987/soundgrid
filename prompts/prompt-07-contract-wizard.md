---
page: contract-wizard
---
Main App Shell: ContractGrid - Contract Creation Wizard
...
**Page Structure:**
1. Full-screen wizard layout without the Bottom Tab Navigation to ensure focus.
2. Top Bar: "Close/Cancel" icon on left, "Step 1 of 5" text indicator in middle.
3. Progress Bar indicating wizard state: Type -> Parties -> Terms -> Payment -> Review.
4. Main Content Area (currently on 'Type' or 'Terms'): large selectable cards (Elevated Surface) or input forms for the current step.
5. Bottom Bar: "Back" secondary button on left, "Next" primary button on right.
