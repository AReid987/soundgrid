...
---
Main App Shell: ContractGrid - Contract Detail view
...
**Page Structure:**
1. Top Bar: "Back" arrow icon, Contract Title.
2. Status Banner (Top level full-width or large card): e.g., "In Escrow", "Signature Required", using Teal Mint or Coral as appropriate.
3. Parties List: Display avatars and names of involved parties.
4. Contract Clauses: Use JetBrains Mono for the actual legal/technical terms text.
5. Timeline: Vertical visual timeline of events (Created -> Signed -> Funded).
6. Floating Action Button / Bottom Bar: Primary primary action (e.g., "Sign Contract" or "Release Funds").
