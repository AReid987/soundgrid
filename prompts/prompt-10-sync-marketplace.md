---
page: sync-marketplace
---
Main App Shell: SyncGrid - Marketplace View
...
**Page Structure:**
1. Bottom Tab Navigation (Active Tab: Sync).
2. Top Navigation Tabs: Segmented control for [Catalog] and [Marketplace]. Active: Marketplace.
3. Browse Briefs: Vertical scrolling feed of available music licensing briefs.
4. Each brief card should show: Project title, budget, requested mood/genre, and a prominent "Match %" badge (e.g., 85% Match in Teal Mint).
5. Search bar at the top (Elevated Surface) with filter icon.
