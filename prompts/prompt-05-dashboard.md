...
page: dashboard
---
Main App Shell: Dashboard (Home) - The main hub for the user
...
**Page Structure:**
1. Bottom Tab Navigation: [Contract] | [Sync] | [Live] | [Profile] (Fixed at bottom)
2. Top Bar: Logo, Notification Icon, User Avatar.
3. Pending Actions section: Vertical stack of urgent cards (e.g., Overdue tasks highlighted with Coral, Signature Required).
4. Stats Grid: 2x2 grid of key metrics (In Escrow, Active, Pending, Completed) using Dark Surface cards.
5. Recent Activity: Simple list of events/notifications.
6. Quick Action FAB (Floating Action Button): [+] button anchored in bottom right for context-aware creation (styled with Electric Indigo).
