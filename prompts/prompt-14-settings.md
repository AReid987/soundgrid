...
**Page Structure:**
1. Bottom Tab Navigation (Active Tab: Profile).
2. Top Profile Summary Section: Large avatar, display name, user role (e.g., "Producer").
3. Simple list-based navigation for account management options: e.g., "Account Information", "Notifications", "Security", "Linked Wallets".
4. Billing Section (Dark Surface card): Shows current plan, next billing date, and a "Manage Plan" secondary button.
5. "Log Out" text button at the very bottom (utility styling).
