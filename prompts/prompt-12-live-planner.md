...
page: live-planner
---
Main App Shell: LiveGrid - Tour Planner
...
2. Top Bar: Title "LiveGrid: Tour Planner".
3. Map-Centric View: Top half of the screen shows a dark-themed map with connected point markers (Electric Indigo) for tour stops.
4. Vertical Stop List: Bottom half of the screen is a scrollable, connected list of dates/venues forming the tour itinerary.
5. Quick Action FAB: [+] to string a new venue into the route.
