...
page: profile-setup
---
Authentication & Onboarding: Profile Setup page
...
2. Circular avatar upload component (often placed near the top, centered).
3. Form fields (Elevated Surface styling) for: Display Name, Location, Genre.
4. Primary "Finish Setup" button at the bottom.
5. Use proper layout padding for a mobile-first responsive feel.
