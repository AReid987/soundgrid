...
page: live-venues
---
Main App Shell: LiveGrid - Venue Discovery
...
**Page Structure:**
1. Bottom Tab Navigation (Active Tab: Live).
2. Top Bar: Search input (Elevated Surface) for finding cities/venues, and a robust Filter button.
3. Venue List: Vertical grid/list of venue cards.
4. Each card should show: Venue hero image or icon, Name, Capacity badge (e.g., "500 cap"), and simple availability indicators (calendars or colored dots).
5. Tapping a card opens a detailed overlay, though the prompt is mainly for the list view.
