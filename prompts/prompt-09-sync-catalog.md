...
page: sync-catalog
---
Main App Shell: SyncGrid - Catalog View
...
2. Top Navigation Tabs: Segmented control for [Catalog] and [Marketplace]. Active: Catalog.
3. Track List: Vertical list of uploaded tracks.
4. Each track list item should have a play button, title, simple waveform visual, and a Status Badge (e.g., "Sync Ready" or "Missing Metadata").
5. Floating Action Button: [+] to upload a new track.
