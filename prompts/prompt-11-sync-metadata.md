...
page: sync-metadata
---
Main App Shell: SyncGrid - Metadata Editor
...
**Page Structure:**
1. Top Bar: "Back" secondary button, Title: "Edit Metadata".
2. Single-page scrolling form layout. No bottom tab navigation in this view.
3. Track Info Section: Large input for Track Title.
4. Technical Metadata Section: Use JetBrains Mono text inputs for ISRC, BPM, Key.
5. Tagging Section: Selectable pill-style tags for Moods and Genres.
6. Ownership Split: Sliders or percentage inputs for Master and Publishing ownership.
7. Bottom Bar (Fixed): Primary button "Save Metadata".
