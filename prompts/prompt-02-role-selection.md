...
page: role-selection
---
Authentication & Onboarding: Role Selection page
...
**Page Structure:**
1. Header: "Select Your Role" with a brief sub-description.
2. Vertical stack of selectable cards representing roles: Artist, Producer, Supervisor, Venue, Manager.
3. Each card should use the Dark Surface styling with interactive hover/active states (e.g. Electric Indigo border on selection).
4. Primary "Continue" button anchored at the bottom (mobile-first approach).
