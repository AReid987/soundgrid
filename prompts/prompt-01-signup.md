...
page: signup
---
Authentication & Onboarding: Sign Up/In page
...
**Page Structure:**
1. Simple centered SoundGrid logo.
2. Form fields for Email Address and Password (with elevated surface background and focus states).
3. Primary button for "Sign In" or "Create Account".
4. Social login buttons (Secondary button style).
5. Ensure a clean, mobile-first centered layout on the near-black background.
